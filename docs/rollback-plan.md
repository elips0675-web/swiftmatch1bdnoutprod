...
�������� 23.08.2026 ����� scripts/verify-backup.ps1 (restore � scratch-�� swiftmatch_verify + sanity-��������):

| ������� | �������� |
|---|---|
| ����� | swiftmatch_2026-08-18_075916.sql (0.3 MB, dev) |
| ������ ���� restore + sanity | **3.6 ���** |
| Sanity-�������� | user_profiles 130, matches 2, messages 213, subscriptions 1 |

**������������� �� ����:** ��� ����� �� �� 1 GB �������������� ~10�15 ��� (mysql restore ~1.5 MB/s + sanity). ������� RTO ��� ����: **< 30 ���**. ������������� ��� � ����� ����� �������.

�������� restore �� ������ �� ����������� �������� ������������� (weekly Task Scheduler ����� install-backup-task.bat).

## N+2. Rate-limit / lockout: ������� �� ��������������� (���� 44, ����� kimi 1.1)

**�������: prod � strictly single-instance �� �������� �� Redis store.**

- express-rate-limit � lockout.js ���������� in-memory ��������� � ������ �� ������� ����� ����������
- ���������: pm2 cluster mode (pm2 start -i > 1), Docker replicas > 1, ����� ��������� ����� ���������� API
- deploy.yml ���������� pm2 restart swiftmatch-api � fork mode (single) � ����������
- ��� ������������� ��������������� �� �����: ��������� ��� ��������� �� rate-limit-redis / Redis-backed lockout (REDIS_URL ��� ���������, ���� 29)
- Nginx-������� (limit_req_zone api 30r/s, auth 5r/s � nginx/swiftmatch.conf) �������� ���������� �� ����� ��������� � ������� ������ ������ ������