...
router.get('/contacts', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Emergency contacts GET error', { error: err.message, userId: req.userId })
...
router.post('/contacts', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Emergency contact POST error', { error: err.message, userId: req.userId })
...
router.delete('/contacts/:id', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Emergency contact DELETE error', { error: err.message, userId: req.userId })
...
router.post('/start', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Check-in start error', { error: err.message, userId: req.userId })
...
router.post('/:id/checkin', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Check-in confirm error', { error: err.message, userId: req.userId })
...
router.post('/:id/cancel', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Check-in cancel error', { error: err.message, userId: req.userId })
...
router.get('/active', auth, async (req, res) => {
  try {
    ...
    rootLogger.error('Active check-ins GET error', { error: err.message, userId: req.userId })
